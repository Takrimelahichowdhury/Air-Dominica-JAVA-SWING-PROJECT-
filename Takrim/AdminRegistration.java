...
public class AdminRegistration {
           ...
           AdminRegistration(){
            ...
            JLabel labelreg = new JLabel("ADMIN REGISTRATION");
            ...
            public void actionPerformed (ActionEvent e)
              {
                   ...
                   else
                   {
                         ...
                         try{
                          ...
                          String query="INSERT INTO `adm`(`NAME`, `EMAIL`, `MOBILE`, `ADMINNAME`, `PASSWORD`, `RE-PASSWORD`) VALUES (?,?,?,?,?,?)";
                          Connection con = DriverManager.getConnection("jdbc:mysql://localhost/admininfo","root","");
